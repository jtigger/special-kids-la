  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved review as @review" do
        ...
        post :create, {:review => { "summary" => "invalid value" }}, valid_session
        expect(assigns(:review)).to be_a_new(Review)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested review" do
        ...
        expect_any_instance_of(Review).to receive(:update).with({ "summary" => "MyString" })
        put :update, {:id => review.to_param, :review => { "summary" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the review as @review" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Review.any_instance.stub(:save).and_return(false)
        put :update, {:id => review.to_param, :review => { "summary" => "invalid value" }}, valid_session
        expect(assigns(:review)).to eq(review)
      end
